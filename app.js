...
const tabsBeforeLogin = [ { id: "notice", label: "公告欄" }, { id: "souvenir", label: "今年紀念品" }, { id: "recommend", label: "推薦套組" }, { id: "tutorial", label: "新手教學" }, { id: "about", label: "服務費用" }, { id: "qa", label: "常見Q✦A" }];
